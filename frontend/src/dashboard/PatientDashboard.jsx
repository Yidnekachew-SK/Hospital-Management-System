...
export default function PatientDashboard({ username, userRole, onLogout }) {
  return (
    <div className="flex h-screen bg-slate-50">
      {/* Sidebar */}
      <div className="w-64 bg-white border-r border-slate-200 p-6 flex flex-col">
        <h2 className="text-2xl font-bold text-green-600 mb-8">Patient Portal</h2>
        <nav className="flex-1 space-y-3">
          ...
          <div className="p-3 hover:bg-slate-100 rounded-lg cursor-pointer">
            <p className="text-slate-700">Records</p>
          </div>
        </nav>
        <button
          onClick={onLogout}
      ...
      <div className="flex-1 p-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-500 mt-2">Patient Dashboard</p>
          </div>
        ...
        <div className="bg-white rounded-lg border border-slate-200 p-8 shadow-sm">
          <div className="text-center space-y-4">
            <h2 className="text-3xl font-bold text-green-600">PATIENT</h2>
            <p className="text-slate-500 text-lg">Patient Role Dashboard</p>
          </div>
        </div>
      </div>
    </div>
